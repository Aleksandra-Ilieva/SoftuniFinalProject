...
- Проверява се за нулева стойност или празно поле.
...
## Вход като Доктор
При клик на бутона „Консултиран“, записът се маркира като консултиран и се премахва от интерфейса, но не се изтрива веднага от базата данни. Записите се изтриват автоматично от базата данни на всеки 2 часа с помощта scheduler.
